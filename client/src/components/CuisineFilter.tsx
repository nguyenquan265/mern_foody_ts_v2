...
import { cuisineList } from './forms/CuisinesSection'
import { Label } from './ui/label'
import { Button } from './ui/button'

type Props = {
  onChanage: (cuisines: string[]) => void
  selectedCuisines: string[]
  isExpanded: boolean
  onExpandedClick: () => void
}

const CuisineFilter = ({ onChanage, selectedCuisines, isExpanded, onExpandedClick }: Props) => {
  const handleCuisinesReset = () => onChanage([])
